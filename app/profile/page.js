            ...
            <form onSubmit={handleSaveProfile} className="space-y-4 md:space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 md:py-3 border-2 border-gray-200 rounded-xl text-xs md:text-sm text-gray-800 focus:outline-none focus:border-brand-navy-900"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 md:py-3 border-2 border-gray-200 rounded-xl text-xs md:text-sm text-gray-800 focus:outline-none focus:border-brand-navy-900 bg-white"
                  >
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-brand-navy-900 to-brand-navy-800 text-white py-3 rounded-xl font-bold text-xs md:text-sm shadow-md hover:shadow-lg hover:from-brand-navy-800 hover:to-brand-navy-900 transition-all disabled:opacity-50"
              >
          ...
          <div className="bg-white rounded-3xl elegant-shadow p-5 md:p-8 border border-gray-150 min-h-[500px]">
            <div className="flex flex-row justify-between items-center mb-6">
              ...
              <button
                ...
                className="bg-brand-navy-900 hover:bg-brand-navy-800 text-white px-4 py-2.5 md:px-5 md:py-3 rounded-xl font-semibold shadow-md transition-all duration-300 disabled:opacity-40 disabled:cursor-not-allowed text-xs md:text-sm"
              >
                + Add Address
              </button>
            </div>
                ...
                {addresses.map((addr) => (
                  <div
                    ...
                    className={`border-2 rounded-2xl p-4 md:p-6 relative flex flex-col justify-between transition-all duration-300 ${
                      addr.isDefault
                        ? 'border-brand-navy-900 bg-brand-cream-100/20 shadow-md'
                  ...
                  >
                    <div>
                      ...
                      <div className="flex justify-between items-start mb-4">
                        ...
                        {addr.isDefault && (
                          <span className="bg-brand-gold-500 text-white text-[9px] md:text-[10px] font-bold uppercase px-2 py-0.5 md:px-2.5 md:py-1 rounded-full shadow-sm">
                            ★ Default
                          </span>
                        )}
                      </div>
                    ...
                    <div className="flex items-center justify-between border-t border-gray-100/70 pt-4 mt-auto">
                      <div className="flex gap-3">
                        <button
                          ...
                          className="text-brand-navy-900 hover:text-brand-navy-800 font-bold text-xs hover:underline"
                        >
                          Edit
                        </button>
                        <button
                      ...
                      {!addr.isDefault && (
                        <button
                          ...
                          className="text-xs text-gray-500 hover:text-brand-navy-900 font-semibold hover:underline"
                        >
                          Set Default
                        </button>
                      )}
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl elegant-shadow w-full max-w-lg overflow-y-auto max-h-[90vh] border border-gray-100">
            ...
            {/* Modal Header */}
            <div className="p-5 md:p-6 border-b border-gray-100 flex justify-between items-center bg-brand-navy-900 text-white">
            ...
            <form onSubmit={handleAddressSubmit} className="p-6 md:p-8 space-y-4 md:space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 md:px-4 md:py-3 border-2 border-gray-200 rounded-xl text-xs md:text-sm focus:outline-none focus:border-brand-navy-900 bg-white"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 md:px-4 md:py-3 border-2 border-gray-200 rounded-xl text-xs md:text-sm focus:outline-none focus:border-brand-navy-900"
                    required
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 md:px-4 md:py-3 border-2 border-gray-200 rounded-xl text-xs md:text-sm focus:outline-none focus:border-brand-navy-900 font-mono"
                    required
                  />
                </div>
              </div>
              ...
              <div className="flex gap-4 pt-6 border-t border-gray-100 mt-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 bg-brand-navy-900 text-white py-3 rounded-xl hover:bg-brand-navy-800 transition-all font-semibold text-xs md:text-sm shadow-md"
                >
