  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-cream-100 to-brand-cream-200 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl elegant-shadow">
        ...
        {error && (
          <div id="login-error" role="alert" className="bg-red-50 border border-red-200 text-red-700 px-5 py-4 rounded-xl flex items-center gap-3">
        ...
        <form className="mt-8 space-y-7" onSubmit={handleSubmit} aria-label="Sign in to your account">
          ...
          <div className="text-center pt-4 border-t border-gray-100">
            <p className="text-gray-600 text-lg">
              ...
              <Link href="/signup" className="text-brand-navy-900 font-semibold hover:text-brand-navy-800 transition-colors duration-300 ml-1">
                Create Account
              </Link>
            </p>
          </div>
