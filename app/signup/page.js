...
function Signup() {
  ...
  async function handleSubmit(e) {
    e.preventDefault();
    const validationError = validateSignupForm({ name, phone, password, confirmPassword });
    if (validationError) {
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl elegant-shadow">
        <div className="text-center">
          <div className="mb-6">
            ...
            <h2 className="text-2xl md:text-4xl font-bold text-gray-800 font-serif">Join Our Family</h2>
            <p className="text-gray-600 mt-2 text-lg">Create your account at Srigovinda collections</p>
          </div>
        </div>
        {error && (
          <div id="signup-error" role="alert" className="bg-red-50 border border-red-200 text-red-700 px-5 py-4 rounded-xl flex items-center gap-3">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit} aria-label="Create your account">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-brand-navy-900 focus:outline-none"
                >
                  {showPassword ? (
          ...
          <div className="text-center pt-4 border-t border-gray-100">
            <p className="text-gray-600 text-lg">
              ...
              <Link href="/login" className="text-brand-navy-900 font-semibold hover:text-brand-navy-800 transition-colors duration-300 ml-1">
                Sign In
              </Link>
            </p>
          </div>
