        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#0f2a4a] focus:outline-none"
                >
                  {showPassword ? (
          ...
          <div className="text-center pt-4 border-t border-gray-100">
            <p className="text-gray-600 text-lg">
              ...
              <Link to="/login" className="text-[#0f2a4a] font-semibold hover:text-[#1b4965] transition-colors duration-300 ml-1">
                Sign In
              </Link>
            </p>
          </div>
