    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 select-none text-left">
      ...
      <div className="space-y-16">
        ...
        <section className="text-center space-y-4 max-w-3xl mx-auto">
          <span className="text-xs font-bold text-[#d4af37] uppercase tracking-widest block mb-2">Our Heritage & Story</span>
          <h1 className="text-3xl md:text-5xl font-bold text-[#0f2a4a] font-serif leading-tight">Sri Govinda Collections</h1>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative rounded-3xl overflow-hidden elegant-shadow aspect-[4/3] bg-gray-100">
            ...
            />
            <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-xl text-xxs font-bold text-[#0f2a4a] shadow border">
        ...
        <section className="bg-gradient-to-b from-[#fbf9f6] to-[#faf6f0] border border-gray-100/50 rounded-3xl p-8 md:p-12 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100/50 space-y-4">
              ...
              <h4 className="text-base md:text-lg font-bold text-[#0f2a4a] font-serif">Premium German Silver</h4>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100/50 space-y-4">
              <span className="text-3xl block">🌟</span>
              <h4 className="text-base md:text-lg font-bold text-[#0f2a4a] font-serif">One Gram Gold</h4>
              <p className="text-xxs md:text-xs text-gray-500 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100/50 space-y-4">
              <span className="text-3xl block">🪔</span>
              <h4 className="text-base md:text-lg font-bold text-[#0f2a4a] font-serif">Sacred Panchaloha</h4>
              <p className="text-xxs md:text-xs text-gray-500 leading-relaxed">
        ...
        <section className="bg-white border border-gray-100 rounded-3xl p-8 md:p-12 elegant-shadow grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          <div className="md:col-span-1 flex flex-col items-center text-center">
            <div className="w-24 h-24 rounded-full bg-gradient-to-r from-[#0b1a30] to-[#0f2a4a] text-white flex items-center justify-center font-bold text-2xl mb-4 font-serif">
              H
            </div>
          ...
          <div className="md:col-span-2 text-left space-y-4 relative pl-4 md:border-l border-gray-100">
            <span className="text-4xl text-[#d4af37] font-serif absolute -top-4 -left-2 opacity-35">“</span>
        ...
        {/* CTA */}
        <section className="bg-gradient-to-r from-[#0f2a4a] to-[#1b4965] text-white rounded-3xl p-8 md:p-12 text-center space-y-6">
          ...
          <div className="pt-2">
            <Link to="/products" className="inline-block bg-white text-[#0f2a4a] hover:bg-[#f0f4f8] px-8 py-3.5 rounded-xl font-bold text-xs md:text-sm transition-all duration-300 shadow-lg hover:scale-[1.03]">
