...
function Products() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-4xl font-bold text-[#8b5a2b] mb-4 font-serif">Srigovinda collections</h1>
      <p className="text-gray-600 text-lg mb-10">Explore our exquisite jewellery collection in German Silver, One Gram Gold, and Panchaloha</p>
