...
function Profile() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        // Fetch profile with structured addresses
    ...
    if (editingAddressId) {
      ...
      updatedAddresses = addresses.map(addr => 
        addr.id === editingAddressId 
          ? { ...addr, ...form, area: form.area.trim(), city: form.city.trim(), state: form.state.trim(), pincode: form.pincode.trim(), phone: form.phone.trim() } 
          : addr
      );
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-3xl elegant-shadow p-8 border border-gray-100 sticky top-28">
            <h2 className="text-2xl font-bold text-gray-800 mb-6 font-serif">Personal Info</h2>
            ...
            <form onSubmit={handleSaveProfile} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  disabled
                  className="w-full px-4 py-3 border border-gray-100 bg-gray-50 rounded-xl text-sm text-gray-400 cursor-not-allowed font-medium focus:outline-none"
                />
              </div>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-3xl elegant-shadow p-8 border border-gray-100 min-h-[500px]">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h2 className="text-2xl font-bold text-gray-800 font-serif">Saved Addresses</h2>
                <p className="text-sm text-gray-500 mt-1">{addresses.length}/4 addresses saved</p>
              </div>
              <button
                type="button"
                  ...
                  >
                    <div>
                      ...
                      <div className="flex justify-between items-start mb-4">
                        ...
                        {addr.isDefault && (
                          <span className="bg-[#d4af37] text-white text-[10px] font-bold uppercase px-2.5 py-1 rounded-full shadow-sm">
                            ★ Default
                          </span>
                        )}
                      </div>
                      ...
                      <div className="text-gray-600 text-sm space-y-1 mb-6">
                        ...
                        <p className="pt-2 text-xs font-medium text-gray-500">📞 Phone: {addr.phone}</p>
                      </div>
                    </div>
            ...
            <form onSubmit={handleAddressSubmit} className="p-8 space-y-5">
              ...
              <div className="flex gap-4 pt-6 border-t border-gray-100 mt-6">
                <button
                  type="button"
                  onClick={() => setShowModal(false)}
                  className="flex-1 border-2 border-gray-200 text-gray-600 py-3 rounded-xl hover:bg-gray-50 transition-all font-semibold text-sm"
                >
                  Cancel
                </button>
                <button
